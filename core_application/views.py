...
def student_transcript(request, student_id=None):
    ...
    enrollments = Enrollment.objects.filter(
        ...
        'grade'
    ).order_by('semester__academic_year__year', 'semester__semester_number', 'unit__code')
    ...
    for enrollment in enrollments:
        ...
        subject_data = {
            ...
            'clinical_marks': grade_info.clinical_marks if grade_info else None,
            'continuous_assessment': grade_info.continuous_assessment if grade_info else None,
            'final_exam_marks': grade_info.final_exam_marks if grade_info else None,
            'total_marks': total_marks,
    ...
    programme_units = student.programme.programme_units.filter(is_active=True)
